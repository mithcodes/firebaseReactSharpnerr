    ...
    <div className="logincontainer">
      ...
      <div className="container m-5">
        <form onSubmit={handleSubmit}>
          ...
          <button onClick={handleForgotPassword} className="btn btn-secondary m-1">Forgot Password</button> {/* Add this button */}
          <p>Do not have an account? <Link to="/register">Signup</Link></p>
          <h6 className='m-2'>or sign with google</h6>
          <button type="button" className="btn btn-primary m-1" onClick={firebase.signWithGoogle}>sign with google</button>
        </form>
      </div>
    </div>
  );
